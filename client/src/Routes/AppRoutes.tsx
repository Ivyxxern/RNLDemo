            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
                ...
                overflow-x-auto">
                    <Table>
                        ...
                        border-gray-100 bg-green-600 text-white 
                        sticky top-0 z-30 text-xs">
                            <TableRow>
                                <TableCell isHeader className="px-5
                                py-3 font-medium text-center">No.</TableCell>
                                <TableCell isHeader className="px-5
                                py-3 font-medium text-start">Gender.</TableCell>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {genders.map((gender, index) => (
                                <TableRow key={index}>
                                    ...
                                    text-center">{gender.value}</TableCell>
                                    <TableCell className="px-4 py-3
                                    text-start">{gender.text}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
